...
@section('financeiro-content')
    ...
    <div class="card shadow-sm mb-3 mt-3">
        ...
        <div class="card-header">
            <a href="{{ route('contas-a-receber.create') }}" class="btn btn-sm btn-outline-primary float-start">
                ...
                <tbody>
                    ...
                    @forelse ($contas as $conta)
                        <tr style="cursor:pointer" data-bs-toggle="modal" data-bs-target="#modalConta{{ $conta->id }}">
                            ...
                            <td>{{ $conta->categoria?->nome ?? ($conta->categoria_nome ?? 'Nenhuma') }}</td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="modalContaLabel{{ $conta->id }}">Detalhes da
                                            Conta
                                            a Receber</h1>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{ route('contas-a-receber.edit', $conta->id) }}" class="btn btn-warning">
                                            Detalhes / Editar
                                        </a>
